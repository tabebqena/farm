...
class PersonForm(forms.ModelForm):
    ...
    class Meta:
        model = Entity
        fields = ("name", "description", "is_worker", "is_vendor", "is_client", "is_shareholder", "is_internal", "active")
        widgets = {
            "name": forms.TextInput(attrs={"class": "form-control", "placeholder": _("Full name")}),
            "description": forms.Textarea(attrs={"class": "form-control", "rows": 3, "placeholder": _("Personal notes")}),
...
class ProjectForm(forms.ModelForm):
    ...
    class Meta:
        model = Entity
        fields = ("name", "description", "is_client", "is_vendor", "is_internal", "active")
        widgets = {
            "name": forms.TextInput(attrs={"class": "form-control", "placeholder": _("Project name")}),
            "description": forms.Textarea(attrs={"class": "form-control", "rows": 3, "placeholder": _("Project scope and goals")}),
            "is_client": forms.CheckboxInput(attrs={"class": "form-check-input"}),
            "is_vendor": forms.CheckboxInput(attrs={"class": "form-check-input"}),
            "is_internal": forms.CheckboxInput(attrs={"class": "form-check-input"}),
            "active": forms.CheckboxInput(attrs={"class": "form-check-input"}),

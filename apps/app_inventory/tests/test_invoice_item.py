...
from apps.app_inventory.tests.general import make_product_template
...
class InvoiceItemTest(TestCase):
    def setUp(self):
        ...
        self.vendor = make_entity("Vendor", is_vendor=True, is_client=True)

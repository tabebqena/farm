...
| SC13 | Product ledger issuance entry; status SOLD | sold product linked to the SALE item carries `SOLD` status | [`create_from_session`](../../apps/app_operation/models/proxies/op_sale.py:204) + `Product.status` | [`test_sale_links_product_as_sold`](../../apps/app_operation/tests/operations/sale/test_sale_sale_reversal.py:331) |
...
| Product status restoration | [`test_sale_links_product_as_sold`](../../apps/app_operation/tests/operations/sale/test_sale_sale_reversal.py:331), [`test_reverse_restores_sold_product_to_active`](../../apps/app_operation/tests/operations/sale/test_sale_sale_reversal.py:337) | SC13, SR11 |
